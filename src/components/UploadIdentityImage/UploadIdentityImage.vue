<template>
  <div>
    <div class="image-container__wrapper">
      <el-image class="image-upload__preview smooth" :src="getPreviewImage" fit="contain" />
...
<script setup lang="ts">
  ...
  const handleClearLoadImage = (): void => {
    ElMessageBox.confirm(
      'Ao excluir a logo marca, você removerá a identidade visual da sua empresa! Deseja continuar com a ação de excluir?',
      'Deseja excluir a logo marca?',
      {
